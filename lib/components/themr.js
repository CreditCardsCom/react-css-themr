  ...
  return function (ThemedComponent) {
    ...
    config = {
      ...
      Themed.prototype.getContextTheme = function getContextTheme() {
        return this.props.contextTheme ? this.props.contextTheme[config.componentName] : {};
      };
      ...
      return Themed;
    }(_react.Component), _class.displayName = 'Themed' + ThemedComponent.name, _class.propTypes = _extends({}, ThemedComponent.propTypes, {
    ...
    return withContext((0, _hoistNonReactStatics2.default)(Themed, ThemedComponent));
  };
};
  ...
  return function ThemedContext(props) {
    return _react2.default.createElement(
      ...
      function (contextTheme) {
        return _react2.default.createElement(Themed, _extends({}, props, {
...
function defaultMapThemrProps(ownProps, theme) {
  var composeTheme = ownProps.composeTheme,
      ...
      contextTheme = ownProps.contextTheme,
      rest = _objectWithoutProperties(ownProps, ['composeTheme', 'innerRef', 'themeNamespace', 'mapThemrProps', 'contextTheme']);
